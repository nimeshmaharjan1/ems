        ...
        <div className="flex flex-col drawer-content">
          <div className="shadow nav-wrapper bg-base-100">
            <div className="justify-between w-full gap-3 lg:px-12 h-26 navbar lg:container lg:mx-auto">
              ...
              <div className="items-center flex-none hidden lg:gap-x-5 gap-4 lg:flex">
          ...
          <main className="flex-1">
            <div
              className={classNames("", {
                "lg:container lg:mx-auto px-6 xl:px-12 my-6 md:my-10 md:mb-[6.6rem] min-h-[calc(100vh-440px)]":
                  !isHome,
              })}
            >
              {children}
