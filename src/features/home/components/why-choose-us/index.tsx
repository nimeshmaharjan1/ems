...
const WhyChooseUs = () => {
  return (
    <section className="container why-choose-us grid grid-cols-8 gap-12 md:px-12 py-24">
      <div className="col-span-2 flex gap-x-4">
        ...
        <div>
          ...
          <p className="prose pt-3">
            ...
            team is always ready to assist you, providing prompt and efficient
            service.
          </p>
        </div>
      </div>
      <div className="col-span-2 flex gap-x-4">
        ...
        <div>
          ...
          <p className="prose pt-3 ">
            We offer a diverse selection of home appliances from top-notch
            brands. Whether you need modern kitchen gadgets or essential
      ...
      <div className="col-span-2 flex gap-x-4">
        ...
        <div>
          ...
          <p className="prose pt-3">
            Our commitment to quality is unwavering. We source products directly
            from reputed manufacturers, ensuring you receive only the best
            products.
          </p>
        </div>
      </div>
      <div className="col-span-2 flex gap-x-4">
        ...
        <div>
          ...
          <p className="prose pt-3">
            With a well-organized logistics network, we guarantee on-time
