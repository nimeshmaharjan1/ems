...
export const OrderEmail = (order: any) => {
  return (
    <Tailwind>
      <Html>
        <Head />
        <Preview>This email is to confirm that we have received your order #{order.orderNumber} and is being processed.</Preview>
        <Body className="bg-white dark:bg-neutral-900 text-black dark:text-white my-auto mx-auto font-sans p-6">
          <Container className="border border-solid border-gray-300 rounded-md mx-auto p-5 pt-8 max-w-xs md:max-w-lg pb-5">
            ...
            <Text className="">
              This email is to confirm that we have received your order #{order.orderNumber} and is being processed.{' '}
            ...
            <Section className="border border-solid border-gray-300 rounded-md p-4">
              <Row className="mb-3">
                ...
                <Column align="right" className="text-green-600 dark:text-green-500">
                  {order.status}
                </Column>
              </Row>{' '}
              <Row className="mb-3">
            ...
            {order.items.map((item: any) => (
              <Row key={item.id} className="mt-4 first:mt-0">
                <Column align="left" className="w-48">
                  <Img src={item?.product?.images?.[0]} width="160" height="125" alt="Product" className="object-cover rounded-md" />
                </Column>
                <Column align="left">
            ...
            <Section className="border border-solid border-gray-300 px-4 pt-3 rounded-md my-8">
              <Row className="mb-3">
                ...
                <Column align="right">Rs. {formatPrice(order?.deliveryCharge)}</Column>
              </Row>
              <Row className="mb-3">
                <Column>
                  <strong>Total</strong>
            ...
            <Text className=" mt-4">We are working our best to fulfill your order.</Text>
            {/* <Text className=" mt-4">
                Order Tracking Link:{" "}
            ...
            <Text className=" mt-4">
              Customer Support: If you have any questions or need assistance, please contact us at +977-9841XXXXXX
            </Text>
            <Text className=" mt-4">We appreciate your patience and understanding. Thank you for choosing us!</Text>
