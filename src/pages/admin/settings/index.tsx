...
import { SettingsSchema, settingsSchema } from '@/features/admin/settings/schema';
...
const Settings: NextPageWithLayout<{ settings: SettingsSchema }> = ({ settings }) => {
  ...
  return (
    <form onSubmit={handleSubmit(saveSettings)} className="grid grid-cols-6 gap-x-4 gap-y-3">
      <div className="col-span-6 md:col-span-3">
        <FormControl label="Store Address">
          <input {...register('storeAddress')} type="text" className="input input-bordered" />
        </FormControl>
      </div>
      <div className="col-span-6 md:col-span-3">
        <FormControl label="Contact Number">
          <input {...register('contactNumber')} type="text" className="input input-bordered" />
        </FormControl>
      </div>
      <div className="col-span-6 md:col-span-3">
        <FormControl label="Tiktok">
          <input {...register('tiktok')} type="text" className="input input-bordered" />
        </FormControl>
      </div>
      <div className="col-span-6 md:col-span-3">
        <FormControl label="Facebook">
          <input {...register('facebook')} type="text" className="input input-bordered" />
        </FormControl>
      </div>
      <div className="col-span-6 md:col-span-3">
        <FormControl label="Delivery Charge">
          <input {...register('deliveryCharge')} type="text" className="input input-bordered" />
        </FormControl>
      </div>
      <div className="col-span-6 md:col-span-3">
